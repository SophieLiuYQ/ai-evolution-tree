...
model_spec:
  ...
  benchmarks:
    - name: Intelligence · AA Intelligence Index
      score: '32.82'
      vs_baseline: 'Rank #34 of 93'
      source_url: 'https://artificialanalysis.ai/models/mercury'
    ...
    - name: Speed · Output tok/s
      score: '825'
      vs_baseline: 'Rank #1 of 308'
      source_url: 'https://artificialanalysis.ai/models/mercury-2'
    - name: Price ($/M tokens)
      score: $0.25 in / $0.75 out
      source_url: 'https://artificialanalysis.ai/models/mercury-2'
  aa_url: 'https://artificialanalysis.ai/models/mercury-2'
...
public_view:
  plain_english: |
    Stub page for Mercury 2. Auto-imported from Artificial Analysis on
  ...
  applications:
    - product: Mercury 2
      ...
      year_deployed: 2026
  investment_angle: |
    Academic / Independent positions Mercury 2 in the frontier-reasoning
...
citations:
  - type: blog
    key: aa_mercury
    title: Mercury 2 — Artificial Analysis catalog entry
    url: 'https://artificialanalysis.ai/models/mercury-2'
    year: 2026
---
