...
public_view:
  plain_english: |
    Stub page for Trinity Large Thinking. Auto-imported from Artificial Analysis on
  ...
  applications:
    - product: Trinity Large Thinking
      ...
      year_deployed: 2026
  investment_angle: |
    Academic / Independent positions Trinity Large Thinking in the frontier-reasoning
