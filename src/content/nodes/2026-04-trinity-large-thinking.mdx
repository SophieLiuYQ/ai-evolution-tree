...
status: active
model_spec:
  parameters: 399B total / 13B active
  ...
  benchmarks:
    - name: Intelligence · AA Intelligence Index
      score: '31.87'
      vs_baseline: 'Rank #36 of 93'
      source_url: 'https://artificialanalysis.ai/models/trinity-large-thinking'
    ...
    - name: Speed · Output tok/s
      score: '140'
      vs_baseline: 'Rank #88 of 308'
      source_url: 'https://artificialanalysis.ai/models/trinity-large-thinking'
    - name: Price ($/M tokens)
      score: $0.23 in / $0.88 out
      source_url: 'https://artificialanalysis.ai/models/trinity-large-thinking'
  aa_url: 'https://artificialanalysis.ai/models/trinity-large-thinking'
  homepage: 'https://www.arcee.ai/'
  availability:
    - open_weights
  reviews:
    feels_like:
...
public_view:
  plain_english: >
    Stub page for Trinity Large Thinking. Auto-imported from Artificial Analysis
    on
  ...
  applications:
    - product: Trinity Large Thinking
      company: Academic / Independent
      year_deployed: 2026
  investment_angle: >
    Academic / Independent positions Trinity Large Thinking in the
    frontier-reasoning
...
citations:
  - type: blog
    key: aa_trinity_large_thinking
    title: Trinity Large Thinking — Artificial Analysis catalog entry
    url: 'https://artificialanalysis.ai/models/trinity-large-thinking'
    year: 2026
---
