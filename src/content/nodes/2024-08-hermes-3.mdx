...
model_spec:
  ...
  benchmarks:
    ...
    - name: Speed · Output tok/s
      score: '28'
      vs_baseline: 'Rank #301 of 308'
      source_url: 'https://artificialanalysis.ai/models/hermes-3-llama-3-1-70b'
    - name: Price ($/M tokens)
...
public_view:
  plain_english: >
    Stub page for Hermes 3 - Llama-3.1 70B. Auto-imported from Artificial
    Analysis on
