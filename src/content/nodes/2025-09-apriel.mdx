...
public_view:
  plain_english: |
    Stub page for Apriel-v1.5-15B-Thinker. Auto-imported from Artificial Analysis on
  ...
  applications:
    - product: "Apriel-v1.5-15B-Thinker"
      ...
      year_deployed: 2025
  investment_angle: |
    Academic / Independent positions Apriel-v1.5-15B-Thinker in the frontier-reasoning
