...
model_spec:
  ...
  benchmarks:
    - name: Intelligence · AA Intelligence Index
      score: '28.33'
      vs_baseline: 'Rank #39 of 93'
      source_url: 'https://artificialanalysis.ai/models/apriel'
  ...
  aa_url: 'https://artificialanalysis.ai/models/apriel-v1-5-15b-thinker'
  availability:
    - open_weights
  reviews:
    feels_like:
...
public_view:
  plain_english: >
    Stub page for Apriel-v1.5-15B-Thinker. Auto-imported from Artificial
    Analysis on
  ...
  applications:
    - product: Apriel-v1.5-15B-Thinker
      company: Academic / Independent
      year_deployed: 2025
  investment_angle: >
    Academic / Independent positions Apriel-v1.5-15B-Thinker in the
    frontier-reasoning
...
citations:
  - type: blog
    key: aa_apriel
    title: Apriel-v1.5-15B-Thinker — Artificial Analysis catalog entry
    url: 'https://artificialanalysis.ai/models/apriel-v1-5-15b-thinker'
    year: 2025
---
