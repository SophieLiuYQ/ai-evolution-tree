...
public_view:
  plain_english: |
    Stub page for NVIDIA Nemotron 3 Super 120B A12B (Reasoning). Auto-imported from Artificial Analysis on
  ...
  applications:
    - product: "NVIDIA Nemotron 3 Super 120B A12B (Reasoning)"
      ...
      year_deployed: 2026
  investment_angle: |
    Nvidia positions NVIDIA Nemotron 3 Super 120B A12B (Reasoning) in the frontier-reasoning
...
citations:
  - type: blog
    ...
    title: "NVIDIA Nemotron 3 Super 120B A12B (Reasoning) — Artificial Analysis catalog entry"
