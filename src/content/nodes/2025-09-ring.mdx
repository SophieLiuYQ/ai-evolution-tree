...
status: active
model_spec:
  parameters: 103B total / 6.1B active
  ...
  benchmarks:
    - name: Intelligence · AA Intelligence Index
      score: '14.02'
      vs_baseline: 'Rank #69 of 93'
      source_url: 'https://artificialanalysis.ai/models/ring'
    ...
    - name: Speed · Output tok/s
      score: '90'
      vs_baseline: 'Rank #154 of 308'
      source_url: 'https://artificialanalysis.ai/models/ring-flash-2-0'
    - name: Price ($/M tokens)
      score: $0.14 in / $0.57 out
      source_url: 'https://artificialanalysis.ai/models/ring-flash-2-0'
  aa_url: 'https://artificialanalysis.ai/models/ring-flash-2-0'
...
public_view:
  plain_english: |
    Stub page for Ring-flash-2.0. Auto-imported from Artificial Analysis on
  ...
  applications:
    - product: Ring-flash-2.0
      company: Academic / Independent
      year_deployed: 2025
  investment_angle: |
    Academic / Independent positions Ring-flash-2.0 in the frontier-reasoning
...
citations:
  - type: blog
    key: aa_ring
    title: Ring-flash-2.0 — Artificial Analysis catalog entry
    url: 'https://artificialanalysis.ai/models/ring-flash-2-0'
    year: 2025
---
