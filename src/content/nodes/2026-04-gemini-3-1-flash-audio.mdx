---
slug: gemini-3-1-flash-audio
title: Gemini 3.1 Flash Audio
...
public_view:
  plain_english: >-
    Gemini 3.1 Flash Audio is an API model from Google. It’s positioned for
  ...
  applications:
    - product: Gemini 3.1 Flash Audio (API / product surface)
      company: Google / DeepMind
      year_deployed: 2026
    - product: Developer tooling built on Gemini 3.1 Flash Audio
      company: Google / DeepMind
      year_deployed: 2026
  investment_angle: >-
...
citations:
  - type: release
    key: c_google_gemini_3_1_flash_audio
    title: Gemini 3.1 Flash Audio
    year: 2026
